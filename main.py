...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.args:
        ...
        if files:
            ...
            await update.message.reply_text("🎥 ویدیوها ارسال شد. تا ۳۰ ثانیه دیگر برای نظم چت حذف می‌شوند.")
        ...
        await update.message.reply_text("سلام! برای ساخت آلبوم از /new و برای دریافت لینک از /finish استفاده کنید.")

async def new_album(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.effective_user.id
    user_collections[user_id] = []
    await update.message.reply_text("✅ حالت ساخت آلبوم فعال شد. ویدیوها را بفرستید.")
